package fr.silverstar.naturecollection.adapter;
...
import fr.silverstar.naturecollection.FavDB;
...
public class CoffeeAdapter extends RecyclerView.Adapter<ru.embersoft.favoritelist.Adapters.CoffeeAdapter.ViewHolder> {

    private ArrayList<PlantModel> coffeeItems;
    private Context context;
    private FavDB favDB;

    public CoffeeAdapter(ArrayList<PlantModel> coffeeItems, Context context) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ru.embersoft.favoritelist.Adapters.CoffeeAdapter.ViewHolder holder, int position) {
    ...
    private void likeClick (CoffeeItem coffeeItem, Button favBtn, final TextView textLike) {
        DatabaseReference refLike = FirebaseDatabase.getInstance("https://favoritelist-c472c-default-rtdb.firebaseio.com/").getReference().child("likes");
