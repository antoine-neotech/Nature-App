...
public class FavAdapter extends RecyclerView.Adapter<ru.embersoft.favoritelist.Adapters.FavAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            refLike = FirebaseDatabase.getInstance("https://favoritelist-c472c-default-rtdb.firebaseio.com/").getReference().child("likes");
